...
class DkfzPrepareIsatabCommand(common.DkfzCommandBase):
    ...
    def setup_argparse(cls, parser: argparse.ArgumentParser) -> None:
        ...
        #parser.add_argument("--panseq", default=False, action='store_true', help="If assay type is panel sequencing, eg. custom wgs.")
        parser.add_argument("--panseq", default=False, help="If assay type is panel sequencing, eg. custom wgs., add the name of the panel")
